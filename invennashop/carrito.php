...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="./">InvernaShop</a>
            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <button type="button" class="btn btn-dark" id="btnPagar" disabled>Pagar</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; InvernaShop 2023 By. JMDL</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
